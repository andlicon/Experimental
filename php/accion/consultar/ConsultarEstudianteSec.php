<?php
    ...
    final class ConsultarEstudianteSec implements Consultor {
        private $dao;
        ...
        public function consultar(array $cedula) {
            ...
            for($i=0; $i<count($registros); $i++) {
                ...
                $validez = $selectValido->crearItemAtributosSeleccionSec("class=\"modificable modificable$idEstudiante ocultar\"", "validoInput$idEstudiante", $estudiante->getValido());
